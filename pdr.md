...
- **Resilienza preloadGapiAuth**: Corretto bug in cui `preloadGapiAuth()` cachava una Promise rifiutata permanentemente dopo un fallimento iniziale. Ora `_gapiAuthReady` viene resettato a `null` in caso di errore.
